...
def parse_args():
    ...
    parser.add_argument('--idx', type=int, default=0, help='index of the dataset, range [0, 1]', choices=range(5))
...
if __name__ == '__main__':
    ...
    discriminator.load_state_dict(torch.load(f'./weights/dis_mosaic_2_112_r18_e5_run{run}.pth', map_location='cpu'))
