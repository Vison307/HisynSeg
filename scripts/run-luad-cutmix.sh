...
python mosaic_train_v2.py --model DeepLabV3Plus --encoder efficientnet-b6 --lr 0.0001 --gpus $GPU --epochs 25 --batch-size 32 --train_image_dirs data/LUAD-HistoSeg/train data/LUAD-HistoSeg/cutmix_image_run${k}/img --train_mask_dirs $LOG_DIR/mask data/LUAD-HistoSeg/cutmix_image_run${k}/mask --num_samples -1 $NUM_SAMPLES_1 --patch-size 224 --val_data data/LUAD-HistoSeg/val --test_data data/LUAD-HistoSeg/test --num-classes 4 --dataset luad --log_dir $LOG_DIR/stage2
