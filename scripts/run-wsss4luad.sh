...
for k in {2..5}
do
LOG_DIR=logs/wsss4luad3k6_3k6_syn0_run${k}

python mosaic_train_v2.py --model DeepLabV3Plus --encoder efficientnet-b6 --lr 0.0001 --gpus $GPU --epochs 60 --batch-size 32 --semi_image_dir data/WSSS4LUAD/1.training --train_image_dirs data/WSSS4LUAD/mosaic_2_112/disc_img_r18_e5 data/WSSS4LUAD/bezier224_5_0.2_0.05_1d1/disc_img_r18_e5 --train_mask_dirs data/WSSS4LUAD/mosaic_2_112/disc_mask_r18_e5 data/WSSS4LUAD/bezier224_5_0.2_0.05_1d1/disc_mask_r18_e5 --num_samples $NUM_SAMPLES $NUM_SAMPLES --patch-size 224 --val_data data/WSSS4LUAD/2.validation/patches_224_224 --test_data data/WSSS4LUAD/3.testing/patches_224_112 --num-classes 3 --dataset wsss4luad --log_dir $LOG_DIR
