...
if __name__ == '__main__':
    ...
    image_save_dir = f"./data/WSSS4LUAD/mosaic_2_112_run{run}/disc_img_r18_e5_3"
    mask_save_dir = f"./data/WSSS4LUAD/mosaic_2_112_run{run}/disc_mask_r18_e5_3"
    ...
    discriminator.load_state_dict(torch.load(f'./weights_3/dis_mosaic_2_112_r18_e5_run{run}.pth', map_location='cpu'))
