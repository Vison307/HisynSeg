...
# %%
train_dir = f"./data/LUAD-HistoSeg/limit_N/one_label_N{N_sample}_run{run}"
...
print('Number of only_tum_list:', len(only_tum_list))
print('Number of only_nec_list:', len(only_nec_list))
print('Number of only_lym_list:', len(only_lym_list))
print('Number of only_tas_list:', len(only_tas_list))
...
discriminator.load_state_dict(torch.load(f'weights_limit_N/dis_luad_bezier224_5_0.2_0.05_1d1_N_{N_sample}_r18_e5_run{run}.pth'))
